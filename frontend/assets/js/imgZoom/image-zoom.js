    ...
    return function ImageZoom(container, opts) {
        ...
        function onSourceImgLoad() {
            ...
            if (options.zoomLensStyle) {
                ...
                data.zoomLens.element.style.height = '190px';
                data.zoomLens.element.style.width = '300px';
                data.zoomLens.element.style.background = ' rgba(239, 57, 78, 0.098)';
                data.zoomLens.element.style.borderRadius = '5px';
                data.zoomLens.element.style.border = '1px solid rgba(239, 57, 78, 0.204)';
